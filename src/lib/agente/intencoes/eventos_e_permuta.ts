...
export const INTENCOES_EVENTOS_E_PERMUTA: IntencaoDef[] = [
  {
    ...
    campos: [
      ...
      { nome: "quantidade", tipo: "numero", descricao: "só o número de cabeças, em algarismos, sem texto junto (20)" },
  ...
  },
  {
    ...
    campos: [
      ...
      { nome: "vendidos", tipo: "numero", descricao: "só o número de cabeças vendidas, em algarismos (12; 0 se nenhuma vendeu)" },
      { nome: "retornados", tipo: "numero", descricao: "só o número de cabeças que voltaram, em algarismos; vazio se não disse" },
