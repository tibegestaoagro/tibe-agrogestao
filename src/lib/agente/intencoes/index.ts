...
export const DESCRICAO_DOS_DOMINIOS: Record<Dominio, string> = {
  ...
  prestador: "para quem presta serviço, duas coisas só: o serviço do catálogo que ele NOMEIA e fez para um cliente, sem citar máquina nem preço (quantos hectares, horas ou diárias, sozinho, continua aqui); e quanto um cliente deve ou já pagou. Começar, terminar ou avançar (\"fiz MAIS tanto\") num serviço já registrado não é daqui, nem o que ele PAGA a quem trabalhou para ele",
