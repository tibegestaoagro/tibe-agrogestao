  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-[var(--curva)] border border-borda bg-superficie p-4">
          <p className="text-xs uppercase tracking-wide text-texto-discreto">Restante</p>
          ...
          <p className="mt-1 text-sm text-texto">
            {proximoVencimento ? (
              ...
              <span className="text-texto-discreto">
                {j.restante === 0 ? "Nada a pagar" : "Sem data"}
              </span>
            )}
          </p>
        </div>
      ...
      <section className="space-y-3">
        ...
        {j.entries.length === 0 ? (
          <EmptyState titulo="Nenhum lançamento" compacto>
            Este serviço não gerou despesa. Acontece quando o valor ficou em zero.
          </EmptyState>
        ) : (
          <Table>
            <TableHeader>
                ...
                <TableRow key={e.id}>
                  ...
                  <TableCell>
                    {e.status === "paid" ? (
                      ...
                      <Badge variant="amber">A pagar</Badge>
                    )}
                  </TableCell>
                  <TableCell>
                    {e.paid_at
