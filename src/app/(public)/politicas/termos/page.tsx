  ...
  return (
    <main className="min-h-screen bg-superficie">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-texto-secundario">
          <section>
            <h2 className="text-lg font-semibold text-texto">1. Sobre o Tibé</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">2. Cadastro e conta</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">3. Teste grátis</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">4. Planos e cobrança</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">5. Atraso e suspensão de acesso</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">6. Cancelamento</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">7. Agente de IA no WhatsApp</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">8. Uso aceitável</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">9. Disponibilidade</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">10. Propriedade intelectual</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">11. Limitação de responsabilidade</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-texto">12. Alterações e legislação aplicável</h2>
            <p className="mt-2">
