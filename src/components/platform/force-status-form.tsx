...
export default function ForceStatusForm({ tenantId }: { tenantId: string }) {
  ...
  return (
    <div className="rounded-md border border-gray-700 bg-gray-950 p-4">
      <p className="text-sm font-medium text-white">Forçar mudança de status</p>
      <div className="mt-3 space-y-3">
        <div>
          ...
          <select
            ...
            className="mt-1 w-full rounded-md border border-gray-700 bg-gray-900 px-3 py-1.5 text-sm text-white"
          >
            {OPTIONS.map((o) => (
